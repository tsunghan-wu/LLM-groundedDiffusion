...
parser.add_argument("--use-freeu", action="store_true")
...
freeu_param = None
if args.use_freeu:
    assert models.sd_version in ["sdv2", "sdv1.4"], "FreeU only supports SDv1.4 and SDv2"
    if models.sd_version == "sdv2":
        freeu_param = {'b1': 1.1, 'b2': 1.2, 's1': 0.9, 's2': 0.2}
    elif models.sd_version == "sdv1.4":
        freeu_param = {'b1': 1.2, 'b2': 1.4, 's1': 0.9, 's2': 0.2}
